...
public class GuardaRailIzquierda extends GameObject implements Updatable, Renderable, Collideable {
    ...
    public GuardaRailIzquierda(double x, double y) {
        super(x, y);
        
        imagenRail = new Image("file:src/main/resources/img/left-guardrail.png", width, heigth, false, false);
        ...
        this.collider = new Rectangle(this.x + 25, this.y, 10, 1000);
    }
